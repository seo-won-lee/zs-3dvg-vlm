...
# Modified for removing 3D spatial information (coordinates)
# --------------------------------------------------------
...
from inference.projection import (
    render_point_cloud_with_pytorch3d_with_objects,
    setup_camera,
    create_point_cloud,
    )
from inference.utils import (
    ...
    load_json,
    load_bboxes,
    generate_objects_info_wo_spatial,
    load_scene_pcd,
)

SYSTEM_INFO = "You are a helpful assistant designed to identify objects based on image and descriptions."
ASK_INFO = "Please review the provided image and object, then select the object ID that best matches the given description. "
...
def process_room(
    ...
    objects_info = generate_objects_info_wo_spatial(mask3d_bboxes.values())
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_dir",
        # required=True,
        default="./outputs/qwen2-vl-7b/nr3d/wo_spatial",
        help="Directory to store the output",
    )
    parser.add_argument(
        "--language_annotation_dir",
        # required=True,
        default="./data/nr3d/query_7B",
