...
from inference.projection2 import render_point_cloud_with_pytorch3d_with_objects
...
def process_room(
    ...
    for i, d in enumerate(tqdm(queries)):
        ...
        new_query = reconstruct_query(
            ...
            include_orig_query=None  # or None
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_dir",
        # required=True,
        # default="./outputs/qwen2-vl-7b/scanrefer/parsed_w_caption",  # uses original caption + reconstructed query
        default="./outputs/qwen2-vl-7b/scanrefer/parsed_wo_caption",  # uses reconstructed query only (no original caption)
